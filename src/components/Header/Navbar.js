...
const Navbar = () => (
  ...
  <div id="navbarCollapse" className="collapse navbar-collapse justify-content-start">		
    ...
    <div className="navbar-nav ml-auto">
      <a href="/#" className="nav-item nav-link active"><i className="fa fa-home" /><span>Inicio</span></a>
      <a href="/#" className="nav-item nav-link"><i className="fa fa-people-carry" /><span>Provedores</span></a>
      <a href="/#" className="nav-item nav-link"><i className="fa fa-users" /><span>Clientes</span></a>
